...
uses
  ...
  SqlExpr, QRExport, QRPDFFilt, jpeg, grimgctrl, dxGDIPlusClasses;

type
  TRptSingleVoucherForm = class(TForm)
    QRVoucher: TQuickRep;
    QRBand1: TQRBand;
    QRGroup1: TQRGroup;
    QRDBText1: TQRDBText;
...
var
  RptSingleVoucherForm: TRptSingleVoucherForm;

implementation

{$R *.DFM}

procedure TRptSingleVoucherForm.FormCreate(Sender: TObject);
begin
