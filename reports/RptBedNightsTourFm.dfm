object RptBedNightsTourForm: TRptBedNightsTourForm
  Left = 192
  Top = 107
  Width = 800
  Height = 480
  Caption = 'RptBedNightsTourForm'
  Color = clBtnFace
  ...
  object QuickRep1: TQuickRep
    ...
    object SummaryBand1: TQRBand
      ...
      object QRExpr1: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(BedNightsCds.NumPax)'
        Mask = '#,##0'
        FontSize = 10
      end
    end
  ...
  object BedNightsSds: TSQLDataSet
    CommandText = 
      'SELECT * FROM dbo.fn_Rpt_Vou_BedNights_Tours('#39'01/01/2005'#39',  '#39'01/' +
      '01/2005'#39', 1)'
    MaxBlobSize = -1
    Params = <>
  ...
  object BedNightsCds: TClientDataSet
    ...
    object BedNightsCdsTourCode: TStringField
      FieldName = 'TourCode'
      Size = 10
    end
    object BedNightsCdsTourDate: TSQLTimeStampField
      FieldName = 'TourDate'
      DisplayFormat = 'dd/mm/yyyy'
    end
    object BedNightsCdsNumPax: TIntegerField
      FieldName = 'NumPax'
    end
  end
