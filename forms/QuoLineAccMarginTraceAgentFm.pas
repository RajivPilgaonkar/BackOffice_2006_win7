unit QuoLineAccMarginTraceAgentFm;
...
type
  TQuoLineAccMarginTraceAgentForm = class(TForm)
    Panel2: TPanel;
    KeyIdDBText: TDBText;
    cxButton2: TcxButton;
    cxButton1: TcxButton;
...
var
  QuoLineAccMarginTraceAgentForm: TQuoLineAccMarginTraceAgentForm;
...
procedure TQuoLineAccMarginTraceAgentForm.FormCreate(Sender: TObject);
begin
  MasterSds.Close;
...
procedure TQuoLineAccMarginTraceAgentForm.cxButton2Click(Sender: TObject);
begin
  Close;
end;

procedure TQuoLineAccMarginTraceAgentForm.cxGridMasterDBBandedTableView1StylesGetContentStyle(
  Sender: TcxCustomGridTableView; ARecord: TcxCustomGridRecord;
  AItem: TcxCustomGridTableItem; out AStyle: TcxStyle);
var
...
procedure TQuoLineAccMarginTraceAgentForm.SaveAsExcel1Click(Sender: TObject);
begin

  SaveDialog.FileName := 'C:\CostingTraceAgent.xls';
  if SaveDialog.Execute then
    ExportGrid4ToExcel_BW_Banded (SaveDialog.FileName, cxGridMaster, True, True, False, cxGridMasterDBBandedTableView1);

end;

procedure TQuoLineAccMarginTraceAgentForm.Print1Click(Sender: TObject);
begin
