inherited ElemCarCostForm: TElemCarCostForm
  Left = 505
  Top = 6
  Width = 723
  Caption = 'Costs (1-10)'
  ...
  inherited Panel2: TPanel
    ...
    inherited cxDBLabelKeyId: TcxDBLabel
      Left = 548
      DataBinding.DataField = 'ElemCarsCosts_id'
    end
      ...
      inherited cxTabSheet1: TcxTabSheet
        inherited cxGrid1: TcxGrid
          ...
          inherited cxGrid1DBBandedTableView1: TcxGridDBBandedTableView
            DataController.KeyFieldNames = 'ElemCarsCosts_id'
            OptionsData.Appending = False
            OptionsData.Deleting = False
            OptionsData.Inserting = False
            object cxGrid1DBBandedTableView1ElemCarsCosts_id: TcxGridDBBandedColumn
              DataBinding.FieldName = 'ElemCarsCosts_id'
              Visible = False
  ...
  inherited MasterSds: TSQLDataSet
    CommandText = 'SELECT * FROM ElemCarsCosts'#13#10'WHERE ElemCars_id = :ElemCars_id'
    CommandType = ctQuery
    Params = <
      item
        DataType = ftInteger
  ...
  inherited MasterCds: TClientDataSet
    ...
    object MasterCdsElemCarsCosts_id: TIntegerField
      FieldName = 'ElemCarsCosts_id'
    end
  ...
  object VehicleSds: TSQLDataSet
    CommandText = 
      ...
      'OM CarHire ch'#13#10'LEFT JOIN Vehicles v ON ch.Vehicles_id = v.Vehicl' +
      'es_id'#13#10'WHERE ch.Addressbook_id = :Addressbook_id'#13#10'ORDER BY v.Veh' +
      'icle'
    MaxBlobSize = -1
    Params = <
      item
