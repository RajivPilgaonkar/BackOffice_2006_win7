object RouteFinderForm: TRouteFinderForm
  Left = 27
  Top = 79
  Width = 951
  Height = 651
  ...
  object Panel6: TPanel
    ...
    object cxLockTimeCkb: TcxCheckBox
      Left = 721
      Top = 8
      Caption = 'Lock Time'
      TabOrder = 1
  ...
  object RouteFinderSds: TSQLDataSet
    CommandText = 'EXEC p_RouteFinder_x '#39'10/02/2018 05:35'#39',103,176,3,1, null'
    MaxBlobSize = -1
    Params = <>
    SQLConnection = BackOfficeDataModule.SQLConnection
    Left = 624
