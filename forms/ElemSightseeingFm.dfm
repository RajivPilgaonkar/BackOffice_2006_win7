inherited ElemSightseeingForm: TElemSightseeingForm
  Left = 84
  Top = 102
  Height = 594
  Caption = 'Elements - Sightseeing'
  ...
  inherited MasterSds: TSQLDataSet
    CommandText = 
      ...
      'ddressbook_id'#13#10'AND es.Wef = :Wef'#13#10'AND es.SightSeeing = 1'#13#10'AND EX' +
      'ISTS (SELECT * FROM Services s'#13#10'WHERE es.Services_id = s.Service' +
      's_id'#13#10'AND s.Cities_id = :Cities_id) '
    CommandType = ctQuery
    Params = <
      item
        DataType = ftInteger
