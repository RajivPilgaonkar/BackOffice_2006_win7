inherited ExchangeRateForm: TExchangeRateForm
  Left = 277
  Top = 104
  Width = 430
  ...
  inherited Panel2: TPanel
    ...
    inherited cxDBLabelKeyId: TcxDBLabel
      Left = 260
      DataBinding.DataField = 'currencydetails_id'
    end
  end
  ...
  inherited MasterSds: TSQLDataSet
    CommandText = 
      'SELECT * FROM CurrencyDetails'#13#10'WHERE Currencies_id = :Currencies' +
      '_id'
    CommandType = ctQuery
    Params = <
      item
  ...
  object CurrenciesSds: TSQLDataSet
    CommandText = 
      ...
      '.Countries_id = co.Countries_id'#13#10'ORDER BY CurrencyCode'#13#10
    MaxBlobSize = -1
    Params = <>
