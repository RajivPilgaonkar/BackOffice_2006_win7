...
type
  TTrainCategoriesForm = class(TCustom_1MG_2DG_Type2_Form)
...
var
  TrainCategoriesForm: TTrainCategoriesForm;
  TrainCategoriesForm_level: integer;
...
procedure TTrainCategoriesForm.FormCreate(Sender: TObject);
begin
  Caption := 'Train Categories';
  ActivateInCustom;

  TrainCategoriesForm_level := 4;
...
procedure TTrainCategoriesForm.FormClose(Sender: TObject;
...
procedure TTrainCategoriesForm.FormDestroy(Sender: TObject);
begin
  inherited;
  TrainCategoriesForm := nil;
end;

procedure TTrainCategoriesForm.ActivateInCustom;
begin
  ...
  Custom_AdmLevel := TrainCategoriesForm_level;
...
procedure TTrainCategoriesForm.FormActivate(Sender: TObject);
begin
  inherited;
  ActivateInCustom;
  cxGrid1.SetFocus;
...
procedure TTrainCategoriesForm.MasterCdsBeforePost(DataSet: TDataSet);
begin
...
procedure TTrainCategoriesForm.Detail1CdsBeforePost(DataSet: TDataSet);
begin
...
procedure TTrainCategoriesForm.Detail2CdsBeforePost(DataSet: TDataSet);
begin
...
function TTrainCategoriesForm.IsMasterRecordDuplicate: Boolean;
var
...
function TTrainCategoriesForm.IsDetail1RecordDuplicate: Boolean;
var
  x_QueryString: string;
  x_duplicate: boolean;
  GpSds: TSQLDataSet;
...
function TTrainCategoriesForm.IsDetail2RecordDuplicate: Boolean;
var
  x_QueryString: string;
  x_duplicate: boolean;
  GpSds: TSQLDataSet;
...
procedure TTrainCategoriesForm.Detail1CdsBeforeInsert(DataSet: TDataSet);
begin
  inherited;
  if MasterCds['TrainCategories_id'] = null then
...
procedure TTrainCategoriesForm.Detail2CdsBeforeInsert(DataSet: TDataSet);
begin
  inherited;
  if MasterCds['TrainCategories_id'] = null then
    raise exception.create ('Please select the category first');
...
procedure TTrainCategoriesForm.Detail1CdsAfterInsert(DataSet: TDataSet);
begin
  inherited;
...
procedure TTrainCategoriesForm.Detail2CdsAfterInsert(DataSet: TDataSet);
begin
  inherited;
...
procedure TTrainCategoriesForm.MasterCdsAfterScroll(DataSet: TDataSet);
begin
  inherited;
  FilterData;
end;

procedure TTrainCategoriesForm.FilterData;
var
...
procedure TTrainCategoriesForm.SetWefCombo;
begin
...
procedure TTrainCategoriesForm.cxWefLCMBPropertiesEditValueChanged(
  Sender: TObject);
begin
  inherited;
  FilterData;
...
procedure TTrainCategoriesForm.PostWef (x_option: integer);
var
  x_wef: TDateTime;
begin
  inherited;
...
procedure TTrainCategoriesForm.Detail1CdsAfterPost(DataSet: TDataSet);
begin
  inherited;
  PostWef(1);
end;

procedure TTrainCategoriesForm.Detail2CdsAfterPost(DataSet: TDataSet);
begin
  inherited;
  PostWef(2);
end;

function TTrainCategoriesForm.GetCityFromStations_id(x_Stations_id: integer): integer;
var
  x_QueryString: string;
  x_cities_id: integer;
  GpSds: TSQLDataSet;
...
procedure TTrainCategoriesForm.cxGrid2DBBandedTableView1from_stations_idPropertiesEditValueChanged(
  Sender: TObject);
var
...
procedure TTrainCategoriesForm.cxGrid2DBBandedTableView1to_stations_idPropertiesEditValueChanged(
  Sender: TObject);
var
  x_cities_id, x_stations_id: integer;
  x_Edit: TcxCustomEdit;
...
function TTrainCategoriesForm.IsDetail1RecordConsistent: Boolean;
var
  x_QueryString: String;
  x_ok: Boolean;
  GpSds: TSQLDataSet;
...
procedure TTrainCategoriesForm.CopyCosts1Click(Sender: TObject);
begin
  inherited;
...
procedure TTrainCategoriesForm.CopyTrainCosts;
var
  GpSds: TSQLDataSet;
begin
