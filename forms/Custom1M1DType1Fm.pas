...
uses
  ...
  cxEdit, cxDBData, cxDBLookupComboBox, cxLabel, cxGridLevel,
  cxGridCustomTableView, cxGridTableView, cxGridDBTableView, cxClasses,
  cxControls, cxGridCustomView, cxGrid, cxContainer, cxGroupBox, Menus,
  cxLookAndFeelPainters, StdCtrls, cxButtons;

type
  TCustom1M1DType1Form = class(TForm)
    Panel1: TPanel;
    Panel2: TPanel;
...
var
  Custom1M1DType1Form: TCustom1M1DType1Form;
...
procedure TCustom1M1DType1Form.FormCreate(Sender: TObject);
begin
  MasterCds.Active := True;
  Detail1Cds.Active := True;
end;

procedure TCustom1M1DType1Form.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
   Action := caFree;
end;

procedure TCustom1M1DType1Form.FormDestroy(Sender: TObject);
begin
  Custom1M1DType1Form := nil ;
end;

procedure TCustom1M1DType1Form.FormKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TCustom1M1DType1Form.MasterCdsBeforeEdit(DataSet: TDataSet);
begin
  if (AdmLevel < 2) then
    begin
...
procedure TCustom1M1DType1Form.MasterCdsBeforeDelete(DataSet: TDataSet);
begin
  if (AdmLevel < 3) then
    begin
      MessageDlg ('Access Denied', mtError, [mbOK], 0);
...
procedure TCustom1M1DType1Form.MasterCdsBeforeInsert(DataSet: TDataSet);
begin
  if (AdmLevel < 2) then
    begin
      MessageDlg ('Access Denied', mtError, [mbOK], 0);
...
procedure TCustom1M1DType1Form.Detail1CdsBeforeEdit(DataSet: TDataSet);
begin
  if (AdmLevel < 2) then
    begin
      MessageDlg ('Access Denied', mtError, [mbOK], 0);
...
procedure TCustom1M1DType1Form.Detail1CdsBeforeDelete(DataSet: TDataSet);
begin
  if (AdmLevel < 3) then
    begin
      MessageDlg ('Access Denied', mtError, [mbOK], 0);
...
procedure TCustom1M1DType1Form.Detail1CdsBeforeInsert(DataSet: TDataSet);
begin
  if (AdmLevel < 2) then
    begin
      MessageDlg ('Access Denied', mtError, [mbOK], 0);
...
procedure TCustom1M1DType1Form.MasterCdsAfterPost(DataSet: TDataSet);
begin
  MasterCds.ApplyUpdates(0);
  //MasterCds.Refresh;
end;

procedure TCustom1M1DType1Form.Detail1CdsAfterPost(DataSet: TDataSet);
begin
  Detail1Cds.ApplyUpdates(0);
  //Detail1Cds.Refresh;
end;

procedure TCustom1M1DType1Form.MasterCdsBeforePost(DataSet: TDataSet);
begin
...
procedure TCustom1M1DType1Form.Detail1CdsBeforePost(DataSet: TDataSet);
begin
...
procedure TCustom1M1DType1Form.FormCloseQuery(Sender: TObject;
...
procedure TCustom1M1DType1Form.MasterCdsAfterDelete(DataSet: TDataSet);
begin
  MasterCds.ApplyUpdates(0);
...
procedure TCustom1M1DType1Form.Detail1CdsAfterDelete(DataSet: TDataSet);
begin
  Detail1Cds.ApplyUpdates(0);
end;

procedure TCustom1M1DType1Form.cxCloseBtnClick(Sender: TObject);
begin
  Close;
end;
