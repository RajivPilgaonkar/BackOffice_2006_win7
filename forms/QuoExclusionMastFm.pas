...
type
  TQuoExclusionMastForm = class(TCustom_1MG_1DG_Form)
...
var
  QuoExclusionMastForm: TQuoExclusionMastForm;
  QuoExclusionMastForm_level: integer;
  QuoExclusionMastForm_QuoExclusions_id: integer;

implementation

uses BackOfficeDM, QuoExclusionDisplayFm, MainFm, QuoExclusionFm,
  QuoExclusionAgentFm;

{$R *.dfm}

procedure TQuoExclusionMastForm.FormCreate(Sender: TObject);
begin
...
procedure TQuoExclusionMastForm.FormClose(Sender: TObject;
...
procedure TQuoExclusionMastForm.FormDestroy(Sender: TObject);
begin
  inherited;
  QuoExclusionMastForm := nil;
end;

procedure TQuoExclusionMastForm.ActivateInCustom;
begin
  ...
  Custom_AdmLevel := QuoExclusionMastForm_level;
...
procedure TQuoExclusionMastForm.FormActivate(Sender: TObject);
begin
  inherited;
  ActivateInCustom;
  cxGrid1.SetFocus;
...
procedure TQuoExclusionMastForm.MasterCdsBeforePost(DataSet: TDataSet);
begin
...
procedure TQuoExclusionMastForm.DetailCdsBeforePost(DataSet: TDataSet);
begin
...
function TQuoExclusionMastForm.IsMasterRecordDuplicate: Boolean;
var
...
function TQuoExclusionMastForm.GetNextMasterSrNo: integer;
var
  GpSds : TSQLDataSet;
  x_Max_SrNo: integer;
begin
...
function TQuoExclusionMastForm.GetNextDetailSrNo(QuoExclusions_id: integer): integer;
var
  GpSds : TSQLDataSet;
  x_Max_SrNo: integer;
begin
...
procedure TQuoExclusionMastForm.MasterCdsAfterInsert(DataSet: TDataSet);
begin
  inherited;
  MasterCds['SrNo'] := GetNextMasterSrNo;
end;

procedure TQuoExclusionMastForm.DetailCdsAfterInsert(DataSet: TDataSet);
begin
  inherited;
...
procedure TQuoExclusionMastForm.AgentExclusions1Click(Sender: TObject);
begin
  inherited;

  QuoExclusionAgentForm_level := 4;
  QuoExclusionAgentForm_QuoExclusions_id := MasterCds['QuoExclusions_id'];

  if QuoExclusionAgentForm = nil then
    Application.CreateForm(TQuoExclusionAgentForm, QuoExclusionAgentForm);
