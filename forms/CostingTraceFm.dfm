object CostingTraceForm: TCostingTraceForm
  Left = 114
  Top = 221
  Width = 1025
  Height = 493
  ...
  object Panel1: TPanel
    ...
    object cxGridMaster: TcxGrid
      ...
      object cxGridMasterDBBandedTableView1: TcxGridDBBandedTableView
        ...
        DataController.KeyFieldNames = 'CostingTrace_id'
        DataController.Summary.DefaultGroupSummaryItems = <>
        DataController.Summary.FooterSummaryItems = <
          item
            Format = '#,##0.00'
        ...
        object cxGridMasterDBBandedTableView1CostingTrace_id: TcxGridDBBandedColumn
          DataBinding.FieldName = 'CostingTrace_id'
          Visible = False
        ...
        object cxGridMasterDBBandedTableView1Vouchers_id: TcxGridDBBandedColumn
  ...
  object MasterSds: TSQLDataSet
    CommandText = 'SELECT * FROM CostingTrace'#13#10'ORDER BY Vouchers_id'
    MaxBlobSize = -1
    Params = <>
  ...
  object MasterCDS: TClientDataSet
    ...
    Left = 208
    Top = 48
    object MasterCDSCostingTrace_id: TIntegerField
      FieldName = 'CostingTrace_id'
  ...
  object CostSds: TSQLDataSet
    CommandText = 'SELECT * FROM CostTrace'#13#10'ORDER BY Vouchers_id'
    MaxBlobSize = -1
    Params = <>
    SQLConnection = BackOfficeDataModule.SQLConnection
    Left = 144
  ...
  object CostCds: TClientDataSet
    Aggregates = <>
    Filtered = True
    IndexFieldNames = 'Costof'
    Params = <>
    ProviderName = 'CostDsp'
    Left = 208
    Top = 88
    object CostCdsvouchers_id: TIntegerField
      FieldName = 'vouchers_id'
    end
    object CostCdscostof: TIntegerField
      FieldName = 'costof'
    end
    object CostCdsdescription: TStringField
      FieldName = 'description'
      Size = 50
    end
    object CostCdscost: TFMTBCDField
      FieldName = 'cost'
      DisplayFormat = '#,##0.00'
      Precision = 15
      Size = 4
    end
    object CostCdscosttrace_id: TIntegerField
      FieldName = 'costtrace_id'
    end
  end
