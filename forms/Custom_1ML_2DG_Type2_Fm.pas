...
type
  TCustom_1ML_2DG_Type2_Form = class(TForm)
    Panel1: TPanel;
    Panel2: TPanel;
    Panel3: TPanel;
    Splitter1: TSplitter;
...
var
  Custom_1ML_2DG_Type2_Form: TCustom_1ML_2DG_Type2_Form;
...
procedure TCustom_1ML_2DG_Type2_Form.FormCreate(Sender: TObject);
begin
...
procedure TCustom_1ML_2DG_Type2_Form.FormClose(Sender: TObject;
...
procedure TCustom_1ML_2DG_Type2_Form.FormDestroy(Sender: TObject);
begin
  Custom_MasterKeyField := '';
  Custom_Detail1KeyField := '';
  Custom_Detail2KeyField := '';
  Custom_1ML_2DG_Type2_Form := nil;
end;


procedure TCustom_1ML_2DG_Type2_Form.MasterCdsAfterDelete(DataSet: TDataSet);
begin
...
procedure TCustom_1ML_2DG_Type2_Form.MasterCdsAfterPost(DataSet: TDataSet);
begin
  MasterCds.ApplyUpdates(0);
end;

procedure TCustom_1ML_2DG_Type2_Form.MasterCdsBeforeEdit(DataSet: TDataSet);
begin
...
procedure TCustom_1ML_2DG_Type2_Form.MasterCdsBeforePost(DataSet: TDataSet);
begin
...
procedure TCustom_1ML_2DG_Type2_Form.MasterCdsBeforeInsert(DataSet: TDataSet);
begin
  if (Custom_AdmLevel < 2) then
    begin
      MessageDlg ('Access Denied', mtError, [mbOK], 0);
...
procedure TCustom_1ML_2DG_Type2_Form.cxButtonCloseClick(Sender: TObject);
begin
  Close;
end;

procedure TCustom_1ML_2DG_Type2_Form.FormCloseQuery(Sender: TObject;
...
procedure TCustom_1ML_2DG_Type2_Form.MasterCdsBeforeDelete(DataSet: TDataSet);
begin
  if (Custom_AdmLevel < 2) then
    begin
      MessageDlg ('Access Denied', mtError, [mbOK], 0);
...
procedure TCustom_1ML_2DG_Type2_Form.Detail1CdsAfterDelete(DataSet: TDataSet);
begin
  Detail1Cds.ApplyUpdates(0);
end;

procedure TCustom_1ML_2DG_Type2_Form.Detail1CdsAfterPost(DataSet: TDataSet);
begin
  Detail1Cds.ApplyUpdates(0);
end;

procedure TCustom_1ML_2DG_Type2_Form.Detail1CdsBeforeEdit(DataSet: TDataSet);
begin
  if (Custom_AdmLevel < 2) then
    begin
      MessageDlg ('Access Denied', mtError, [mbOK], 0);
...
procedure TCustom_1ML_2DG_Type2_Form.Detail1CdsBeforePost(DataSet: TDataSet);
begin
...
procedure TCustom_1ML_2DG_Type2_Form.Detail1CdsBeforeInsert(DataSet: TDataSet);
begin
  if (Custom_AdmLevel < 2) then
    begin
      MessageDlg ('Access Denied', mtError, [mbOK], 0);
...
procedure TCustom_1ML_2DG_Type2_Form.Detail1CdsBeforeDelete(DataSet: TDataSet);
begin
  if (Custom_AdmLevel < 2) then
    begin
      MessageDlg ('Access Denied', mtError, [mbOK], 0);
...
procedure TCustom_1ML_2DG_Type2_Form.FormResize(Sender: TObject);
begin
  SetFormDimensions;
...
procedure TCustom_1ML_2DG_Type2_Form.SetFormDimensions;
begin
...
procedure TCustom_1ML_2DG_Type2_Form.Detail2CdsAfterDelete(
  DataSet: TDataSet);
begin
  Detail2Cds.ApplyUpdates(0);
end;

procedure TCustom_1ML_2DG_Type2_Form.Detail2CdsAfterPost(
  DataSet: TDataSet);
begin
  Detail2Cds.ApplyUpdates(0);
end;

procedure TCustom_1ML_2DG_Type2_Form.Detail2CdsBeforeEdit(
  DataSet: TDataSet);
begin
  if (Custom_AdmLevel < 2) then
    begin
...
procedure TCustom_1ML_2DG_Type2_Form.Detail2CdsBeforePost(
  DataSet: TDataSet);
begin
...
procedure TCustom_1ML_2DG_Type2_Form.Detail2CdsBeforeInsert(
  DataSet: TDataSet);
begin
  if (Custom_AdmLevel < 2) then
    begin
...
procedure TCustom_1ML_2DG_Type2_Form.Detail2CdsBeforeDelete(
  DataSet: TDataSet);
begin
  if (Custom_AdmLevel < 2) then
    begin
