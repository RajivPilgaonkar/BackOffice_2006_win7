object QuoLineCostTraceForm: TQuoLineCostTraceForm
  Left = 295
  Top = 222
  Width = 692
  Height = 493
  ...
  object Panel1: TPanel
    ...
    object cxGridMaster: TcxGrid
      ...
      object cxGridMasterDBBandedTableView1: TcxGridDBBandedTableView
        ...
        DataController.KeyFieldNames = 'QuoLineCostTrace_id'
        DataController.Summary.DefaultGroupSummaryItems = <>
        DataController.Summary.FooterSummaryItems = <
          item
            Format = '#,##0.00'
        ...
        object cxGridMasterDBBandedTableView1CostingTrace_id: TcxGridDBBandedColumn
          DataBinding.FieldName = 'QuoLineCostTrace_id'
          Visible = False
        ...
        object cxGridMasterDBBandedTableView1Iteration: TcxGridDBBandedColumn
          DataBinding.FieldName = 'Iteration'
          Options.Editing = False
          Options.Filtering = False
          Options.Grouping = False
          Options.Sorting = False
  ...
  object MasterSds: TSQLDataSet
    CommandText = 'SELECT * FROM QuoLineCostTrace'#13#10'ORDER BY Iteration, Rectype'#13#10
    MaxBlobSize = -1
    Params = <>
  ...
  object MasterCDS: TClientDataSet
    ...
    object MasterCDSQuoLineCostTrace_id: TIntegerField
      FieldName = 'QuoLineCostTrace_id'
    end
    object MasterCDSQuoLines_id: TIntegerField
      FieldName = 'QuoLines_id'
    end
    object MasterCDSIteration: TIntegerField
      FieldName = 'Iteration'
    end
  end
