...
type
  TCustom_1ML_1DG_Form = class(TForm)
    Panel1: TPanel;
    Panel2: TPanel;
    Panel3: TPanel;
    Splitter1: TSplitter;
...
var
  Custom_1ML_1DG_Form: TCustom_1ML_1DG_Form;
...
procedure TCustom_1ML_1DG_Form.FormCreate(Sender: TObject);
begin
...
procedure TCustom_1ML_1DG_Form.FormClose(Sender: TObject;
...
procedure TCustom_1ML_1DG_Form.FormDestroy(Sender: TObject);
begin
  Custom_MasterKeyField := '';
  Custom_DetailKeyField := '';
  Custom_1ML_1DG_Form := nil;
end;


procedure TCustom_1ML_1DG_Form.MasterCdsAfterDelete(DataSet: TDataSet);
begin
...
procedure TCustom_1ML_1DG_Form.MasterCdsAfterPost(DataSet: TDataSet);
begin
  MasterCds.ApplyUpdates(0);
end;

procedure TCustom_1ML_1DG_Form.MasterCdsBeforeEdit(DataSet: TDataSet);
begin
...
procedure TCustom_1ML_1DG_Form.MasterCdsBeforePost(DataSet: TDataSet);
begin
...
procedure TCustom_1ML_1DG_Form.MasterCdsBeforeInsert(DataSet: TDataSet);
begin
  if (Custom_AdmLevel < 2) then
    begin
      MessageDlg ('Access Denied', mtError, [mbOK], 0);
...
procedure TCustom_1ML_1DG_Form.cxButtonCloseClick(Sender: TObject);
begin
  Close;
end;

procedure TCustom_1ML_1DG_Form.FormCloseQuery(Sender: TObject;
...
procedure TCustom_1ML_1DG_Form.MasterCdsBeforeDelete(DataSet: TDataSet);
begin
  if (Custom_AdmLevel < 2) then
    begin
      MessageDlg ('Access Denied', mtError, [mbOK], 0);
...
procedure TCustom_1ML_1DG_Form.DetailCdsAfterDelete(DataSet: TDataSet);
begin
  DetailCds.ApplyUpdates(0);
end;

procedure TCustom_1ML_1DG_Form.DetailCdsAfterPost(DataSet: TDataSet);
begin
  DetailCds.ApplyUpdates(0);
end;

procedure TCustom_1ML_1DG_Form.DetailCdsBeforeEdit(DataSet: TDataSet);
begin
  if (Custom_AdmLevel < 2) then
    begin
      MessageDlg ('Access Denied', mtError, [mbOK], 0);
...
procedure TCustom_1ML_1DG_Form.DetailCdsBeforePost(DataSet: TDataSet);
begin
...
procedure TCustom_1ML_1DG_Form.DetailCdsBeforeInsert(DataSet: TDataSet);
begin
  if (Custom_AdmLevel < 2) then
    begin
      MessageDlg ('Access Denied', mtError, [mbOK], 0);
...
procedure TCustom_1ML_1DG_Form.DetailCdsBeforeDelete(DataSet: TDataSet);
begin
  if (Custom_AdmLevel < 2) then
    begin
      MessageDlg ('Access Denied', mtError, [mbOK], 0);
...
procedure TCustom_1ML_1DG_Form.FormResize(Sender: TObject);
begin
  SetFormDimensions;
...
procedure TCustom_1ML_1DG_Form.SetFormDimensions;
begin
