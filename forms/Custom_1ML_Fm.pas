...
uses
  ...
  cxGrid, FMTBcd, DBClient, Provider, SqlExpr, cxNavigator, cxDBNavigator;

type
  TCustom_1ML_Form = class(TForm)
    Panel1: TPanel;
    Panel2: TPanel;
    Panel3: TPanel;
...
var
  Custom_1ML_Form: TCustom_1ML_Form;
...
procedure TCustom_1ML_Form.FormCreate(Sender: TObject);
begin
...
procedure TCustom_1ML_Form.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure TCustom_1ML_Form.FormDestroy(Sender: TObject);
begin
  Custom_MasterkeyField := '';
  Custom_1ML_Form := nil;
end;

procedure TCustom_1ML_Form.MasterCdsAfterDelete(DataSet: TDataSet);
begin
  MasterCds.ApplyUpdates(0);
//  MasterCds.Refresh;
end;

procedure TCustom_1ML_Form.MasterCdsAfterPost(DataSet: TDataSet);
begin
  MasterCds.ApplyUpdates(0);
end;

procedure TCustom_1ML_Form.MasterCdsBeforeEdit(DataSet: TDataSet);
begin
...
procedure TCustom_1ML_Form.MasterCdsBeforePost(DataSet: TDataSet);
begin
...
procedure TCustom_1ML_Form.MasterCdsBeforeInsert(DataSet: TDataSet);
begin
  if (Custom_AdmLevel < 2) then
    begin
      MessageDlg ('Access Denied', mtError, [mbOK], 0);
...
procedure TCustom_1ML_Form.cxButtonCloseClick(Sender: TObject);
begin
  Close;
end;

procedure TCustom_1ML_Form.FormCloseQuery(Sender: TObject;
...
procedure TCustom_1ML_Form.MasterCdsBeforeDelete(DataSet: TDataSet);
begin
  if (Custom_AdmLevel < 2) then
    begin
      MessageDlg ('Access Denied', mtError, [mbOK], 0);
...
procedure TCustom_1ML_Form.FormResize(Sender: TObject);
begin
...
procedure TCustom_1ML_Form.SetFormDimensions;
begin
