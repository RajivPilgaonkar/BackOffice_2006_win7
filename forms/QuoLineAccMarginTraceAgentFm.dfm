object QuoLineAccMarginTraceAgentForm: TQuoLineAccMarginTraceAgentForm
  Left = 295
  Top = 222
  Width = 692
  Height = 493
  ...
  object Panel1: TPanel
    ...
    object cxGridMaster: TcxGrid
      ...
      object cxGridMasterDBBandedTableView1: TcxGridDBBandedTableView
        ...
        DataController.KeyFieldNames = 'BreakTransCosts_id'
        DataController.Summary.DefaultGroupSummaryItems = <>
        DataController.Summary.FooterSummaryItems = <
          item
            Format = '#,##0.00'
  ...
  object MasterSds: TSQLDataSet
    CommandText = 
      'SELECT * FROM BreakTransCosts'#13#10'ORDER BY Code, DayNo, BreakTransC' +
      'osts_id'#13#10
    MaxBlobSize = -1
    Params = <>
  ...
  object MasterCDS: TClientDataSet
    ...
    Left = 208
    Top = 48
    object MasterCDSBreakTransCosts_id: TIntegerField
      FieldName = 'BreakTransCosts_id'
    end
